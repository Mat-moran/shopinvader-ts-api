...
var shopinvader_boundary_1 = require("./shopinvader-boundary");
...
function createShopinvaderProvider(_a) {
    ...
    return {
        getCart: function (email) { return __awaiter(_this, void 0, void 0, function () {
            var parsedEmail, res, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        parsedEmail = zod_1.z.string().email().safeParse(email);
                        if (parsedEmail.success === false) {
                            return [2 /*return*/, { message: "Error", success: false, error: parsedEmail.error, error_type: "zod" }];
                        }
                        return [4 /*yield*/, fetch(erp_url_base_url + 'cart/', fetchOptions({ website_unique_id: website_unique_id, api_key: api_key, email: parsedEmail.data }))
                    ...
                    case 1:
                        ...
                        _a = utils_1.zodParse;
                        _b = [shopinvader_boundary_1.ZCart];
                        return [4 /*yield*/, res.json()];
                    case 2: return [2 /*return*/, _a.apply(void 0, _b.concat([_c.sent()]))];
                    case 3: return [2 /*return*/, { message: "Error al tratar de conectar con el ERP", success: res.ok, error: res.status, error_type: "erp api" }];
                }
            });
        }); },
    };
